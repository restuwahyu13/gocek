...
func (h *gocekAssertion) ToBeMinus() {
	input := h.v
	...
	if !reflect.DeepEqual(input, nil) {
		...
		if inputType == reflect.Float32.String() {
			if h.o == "==" && input.(float32) > 0 {
				h.t.FailNow()
			} else if h.o == "!=" && input.(float32) < 0 {
				h.t.FailNow()
			}
		} else if inputType == reflect.Float64.String() {
			if h.o == "==" && input.(float64) > 0 {
				h.t.FailNow()
			} else if h.o == "!=" && input.(float64) < 0 {
				h.t.FailNow()
			}
		} else if inputType == reflect.Int.String() {
			if h.o == "==" && input.(int) > 0 {
				h.t.FailNow()
			} else if h.o == "!=" && input.(int) < 0 {
				h.t.FailNow()
			}
		} else if inputType == reflect.Int8.String() {
			if h.o == "==" && input.(int8) > 0 {
				h.t.FailNow()
			} else if h.o == "!=" && input.(int8) < 0 {
				h.t.FailNow()
			}
		} else if inputType == reflect.Int16.String() {
			if h.o == "==" && input.(int16) > 0 {
				h.t.FailNow()
			} else if h.o == "!=" && input.(int16) < 0 {
				h.t.FailNow()
			}
		} else if inputType == reflect.Int32.String() {
			if h.o == "==" && input.(int32) > 0 {
				h.t.FailNow()
			} else if h.o == "!=" && input.(int32) < 0 {
				h.t.FailNow()
			}
		} else if inputType == reflect.Int64.String() {
			if h.o == "==" && input.(int64) > 0 {
				h.t.FailNow()
			} else if h.o == "!=" && input.(int64) < 0 {
				h.t.FailNow()
			}
		}
	} else {
