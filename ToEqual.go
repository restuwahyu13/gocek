...
func (h *assertion) ToEqual(value interface{}) {
	...
	if !reflect.DeepEqual(input, nil) && !reflect.DeepEqual(value, nil) {
		...
		isObjectType := typeOfFirst == reflect.Array.String() || typeOfFirst == reflect.Slice.String() || typeOfSecond == reflect.Array.String() || typeOfSecond == reflect.Slice.String()
		...
		} else if len(helpers.ToInterfaceMap(input)) == len(helpers.ToInterfaceMap(value)) && reflect.TypeOf(input).Kind().String() == reflect.Map.String() && reflect.TypeOf(value).Kind().String() == reflect.Map.String() || reflect.TypeOf(input).Kind().String() == reflect.Struct.String() && reflect.TypeOf(value).Kind().String() == reflect.Struct.String() {
